...
public class AESUtil {
    ...
    private static final String CIPHER_ALGORITHM = "AES/CBC/PKCS5Padding"; // AES/CBC/PKCS5Padding
    private static final String SECRET_KEY_ALGORITHM = "PBKDF2WithHmacSHA1"; // "PBKDF2WithHmacSHA256"
									     // //"PBKDF2WithHmacSHA1"
	...
	try {
	    ...
	    String cipherText = encrypt(salt, iv, pass, plainText);
    ...
    public String decrypt(String cipherText, String pass) {
	try {
	    ...
	    return decrypt(salt, iv, pass, ct);
	} catch (Exception e) {
	    return null;
	}
    }
